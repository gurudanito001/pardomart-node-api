        ...
        switch (_a.label) {
            case 0:
                ...
                if (!payload.type || !payload.amount) {
                    return [2 /*return*/, res.status(400).json({ error: 'Fee type and amount are required.' })];
                }
                if (!Object.values(client_1.FeeType).includes(payload.type)) {
                    return [2 /*return*/, res.status(400).json({ error: "Invalid FeeType: " + payload.type })];
                }
                if (typeof payload.amount !== 'number' || payload.amount < 0) {
                    return [2 /*return*/, res.status(400).json({ error: 'Amount must be a non-negative number.' })];
                }
        ...
        switch (_a.label) {
            case 0:
                ...
                if (payload.amount !== undefined && (typeof payload.amount !== 'number' || payload.amount < 0)) {
                    return [2 /*return*/, res.status(400).json({ error: 'Amount must be a non-negative number if provided.' })];
                }
                if (payload.isActive !== undefined && typeof payload.isActive !== 'boolean') {
                    return [2 /*return*/, res.status(400).json({ error: 'isActive must be a boolean if provided.' })];
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!Object.values(client_1.FeeType).includes(type)) {
                    return [2 /*return*/, res.status(400).json({ error: "Invalid FeeType: " + type })];
                }
