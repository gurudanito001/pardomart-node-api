    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , authService.storeVerificationCode(newUser === null || newUser === void 0 ? void 0 : newUser.mobileNumber, verificationCode)];
        ...
        case 2:
          ...
          return [4
          /*yield*/
          , verification_1.sendVerificationCode(newUser === null || newUser === void 0 ? void 0 : newUser.mobileNumber, verificationCode)];
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , authService.checkUserExistence({
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , authService.storeVerificationCode(mobileNumber, verificationCode)];
        ...
        case 2:
          ...
          return [4
          /*yield*/
          , verification_1.sendVerificationCode(mobileNumber, verificationCode)];
...
exports.verifyCodeAndLogin = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , authService.verifyCodeAndLogin(mobileNumber, verificationCode, role)];
