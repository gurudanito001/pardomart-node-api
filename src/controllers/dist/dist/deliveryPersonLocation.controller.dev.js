...
exports.addLocationController = function (req, res) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , deliveryPersonLocationService.addDeliveryPersonLocation(orderId, deliveryPersonId, latitude, longitude)];
        ...
        case 2:
          error_1 = _b.sent();
          res.status(error_1.statusCode || 500).json({
...
exports.getPathController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , deliveryPersonLocationService.getDeliveryPath(orderId, userId, userRole)];
