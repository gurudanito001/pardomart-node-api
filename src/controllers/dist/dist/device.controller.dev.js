...
exports.registerDeviceController = function (req, res) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , deviceService.registerDevice(userId, fcmToken, platform)];
...
exports.unregisterDeviceController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
