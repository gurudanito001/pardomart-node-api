    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          payload = req.body; // Sanitize image data: remove data URI prefix if it exists.
          ...
          return [4
          /*yield*/
          , vendorService.createVendor(__assign(__assign({}, payload), {
            userId: req.userId
          }))];
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , vendorService.getVendorById(req.params.id, latitude, longitude)];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          id = req.params.id;
          payload = __assign({}, req.body); // When using formData, nested objects, booleans, and numbers might be sent as strings.
...
exports.getVendorsByUserId = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var vendors, error_6;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , vendorService.getVendorsByUserId(req.userId)];
...
exports.getIncompleteSetups = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , vendorService.getVendorsByUserIdWithProductCount(userId)];
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , vendorService.getVendorDocumentCounts(vendors.map(function (v) {
            return v.id;
          }))];

        case 2:
          documentCounts = _a.sent();
          documentCountMap_1 = new Map(documentCounts.map(function (item) {
            return [item.referenceId, item._count._all];
          }));
...
exports.publishVendor = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , vendorService.publishVendor(id, userId)];
...
exports.approveVendor = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          error_9 = _a.sent();
          res.status(error_9.message.includes('not found') ? 404 : 500).json({
