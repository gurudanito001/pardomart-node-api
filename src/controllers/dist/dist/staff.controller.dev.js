...
exports.createStaffController = function (req, res) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , staffService.createStaffService(__assign(__assign({}, req.body), {
            ownerId: ownerId
          }))];
...
exports.listStaffTransactionsController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , staffService.listStaffTransactionsService(ownerId, {
        ...
        case 2:
          ...
          res.status(500).json({
            error: 'An unexpected error occurred while fetching staff transactions.'
          });
          return [3
          /*break*/
          , 3];
...
exports.listStaffForVendorOrAdminController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          res.status(500).json({
            error: 'An unexpected error occurred while listing staff.'
          });
          return [3
          /*break*/
          , 3];
...
exports.listStaffByVendorController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , staffService.listStaffByVendorIdService(vendorId, ownerId)];
...
exports.getStaffByIdController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , staffService.getStaffByIdService(staffId, ownerId)];
...
exports.updateStaffController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , staffService.updateStaffService(__assign(__assign({}, req.body), {
            staffId: staffId,
            ownerId: ownerId
          }))];
        ...
        case 2:
          ...
          res.status(500).json({
            error: error_6.message || 'Internal server error'
          });
          return [3
          /*break*/
          , 3];
...
exports.deleteStaffController = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , staffService.deleteStaffService(staffId, ownerId)];
        ...
        case 2:
          ...
          res.status(500).json({
            error: error_7.message || 'Internal server error'
          });
          return [3
          /*break*/
          , 3];
