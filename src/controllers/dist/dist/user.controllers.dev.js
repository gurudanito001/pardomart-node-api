    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , userService.getAllUsers(filters, pagination)];
...
exports.getAllVerificationCodes = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , userService.getAllVerificationCodes()];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , userService.updateUser(__assign({
            id: userId
          }, req.body))];
        ...
        case 2:
          ...
          if ((error_5 === null || error_5 === void 0 ? void 0 : error_5.code) === 'P2025') {
            // Prisma's error code for record not found on update
            return [2
            /*return*/
            , res.status(404).json({
              error: 'User not found'
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          if ((error_6 === null || error_6 === void 0 ? void 0 : error_6.code) === 'P2025') {
            // Prisma's error code for record not found on delete
            return [2
            /*return*/
            , res.status(404).json({
              error: 'User not found'
