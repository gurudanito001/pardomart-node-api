        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                vendorProducts.forEach(function (vProduct) {
                    var distance = getPreciseDistance_1["default"]({ latitude: userLatitude, longitude: userLongitude }, { latitude: vProduct.vendor.latitude || 0, longitude: vProduct.vendor.longitude || 0 });
