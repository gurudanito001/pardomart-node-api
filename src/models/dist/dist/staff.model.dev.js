...
exports.deleteStaff = exports.updateStaff = exports.getStaffById = exports.listStaffByOwnerId = exports.listStaffByVendorId = exports.createStaff = void 0; // models/staff.model.ts
...
exports.createStaff = function (payload) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          /*yield*/
          , prisma.user.create({
            data: __assign(__assign({}, payload), {
              role: client_1.Role.store_shopper
            })
          })];

        case 1:
          staffUser = _a.sent(); // We don't need to explicitly connect the vendor,
...
exports.listStaffByVendorId = function (vendorId) {
  return __awaiter(void 0, void 0, Promise, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
...
exports.listStaffByOwnerId = function (ownerId) {
  return __awaiter(void 0, void 0, Promise, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
...
exports.updateStaff = function (staffId, payload) {
  return __awaiter(void 0, void 0, Promise, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
...
exports.deleteStaff = function (staffId) {
  return __awaiter(void 0, void 0, Promise, function () {
    return __generator(this, function (_a) {
