...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0', // You can replace this with the imported version if available
    ...
    servers: [
      {
        url: 'http://localhost:5000/api/v1', // Adjust if your base URL is different
          ...
          allOf: [
            { $ref: '#/components/schemas/Product' },
            {
              ...
              properties: {
                ...
                tags: { type: 'array', items: { $ref: '#/components/schemas/Tag' } }, // Assuming a Tag schema exists
              },
            },
          ],
        },
