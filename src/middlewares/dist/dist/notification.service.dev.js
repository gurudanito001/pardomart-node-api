...
exports.getUnreadCount = exports.markAllAsRead = exports.markAsRead = exports.getNotifications = exports.notifyVendorOfNewOrder = exports.createAndSendNotification = void 0; // src/services/notification.service.ts
...
exports.createAndSendNotification = function (args) {
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          notificationPromises = vendorUsers.map(function (user) {
            return exports.createAndSendNotification({
              userId: user.id,
              title: title,
              body: body,
