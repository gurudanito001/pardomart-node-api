...
exports.createDeliveryAddressService = function (payload, tx) { return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
        createAddressInTx = function (prismaClient) { return __awaiter(void 0, void 0, void 0, function () {
            var addressCount, makeDefault;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prismaClient.deliveryAddress.count({
                            where: { userId: payload.userId }
                        })];
                    case 1:
                        addressCount = _a.sent();
                        makeDefault = addressCount === 0 || payload.isDefault;
                        if (!makeDefault) return [3 /*break*/, 3];
                    ...
                    return [2 /*return*/, deliveryAddressModel.createDeliveryAddress(__assign(__assign({}, payload), { isDefault: makeDefault !== null && makeDefault !== void 0 ? makeDefault : false }), prismaClient)];
                }
            });
        }); };
        if (tx) {
