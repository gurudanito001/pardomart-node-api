...
exports.createOrderService = function (payload) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , orderModel.createOrder(payload)];
...
exports.getOrderByIdService = function (id) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , rating_service_1.getAggregateRatingService({
            ratedVendorId: order.vendorId
          })];
        ...
        case 2:
          ...
          orderWithExtras = __assign(__assign({}, order), {
            vendor: __assign(__assign({}, order.vendor), {
              rating: rating || {
                average: 0,
                count: 0
              },
...
var generateUniqueOrderCode = function generateUniqueOrderCode(tx) {
  return __awaiter(void 0, void 0, Promise, function () {
...
exports.getOrdersByUserIdService = function (userId) {
  return __awaiter(void 0, void 0, Promise, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
...
var getDayEnumFromDayjs = function getDayEnumFromDayjs(dayjsDayIndex) {
  var days = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
  return days[dayjsDayIndex];
};

exports.createOrderFromClient = function (userId, payload) {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          if (!scheduledDeliveryTime) return [3
          /*break*/
          , 2];
          ...
          return [4
          /*yield*/
          , vendor_service_1.getVendorById(vendorId)];
        ...
        case 1:
          ...
          openingHoursToday = vendor.openingHours.find(function (h) {
            return h.day === dayOfWeek_1;
          });
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    return [4
                    /*yield*/
                    , fee_service_1.calculateOrderFeesService({
                  ...
                  case 1:
                    ...
                    finalTotalAmount = subtotal + (deliveryFee || 0) + (serviceFee || 0) + (shoppingFee || 0) + (shopperTip || 0) + (deliveryPersonTip || 0);
                    return [4
                    /*yield*/
                    , generateUniqueOrderCode(tx)];
                  ...
                  case 2:
                    ...
                    , orderModel.createOrder({
                      ...
                      deliveryPersonTip: deliveryPersonTip,
                  ...
                  case 4:
                    if (!(_i < orderItems_1.length)) return [3
                    /*break*/
                    , 7];
                    ...
                    , tx.orderItem.create({
                      data: {
                        ...
                        replacements: item.replacementIds ? {
                          connect: item.replacementIds.map(function (id) {
                            return {
                              id: id
                            };
                          })
                  ...
                  case 7:
                    return [4
                    /*yield*/
                    , orderModel.getOrderById(newOrder.id, tx)];
                  ...
                  case 9:
                    // --- Add Notification Logic Here ---
                    // --- Add Notification Logic Here ---
                    _a.sent(); // I will remove it later
                  ...
                  case 10:
                    ...
                    _a.sent(); // --- End Notification Logic ---
...
exports.updateOrderTipService = function (orderId, userId, payload) {
  return __awaiter(void 0, void 0, Promise, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
          ...
          return __generator(this, function (_c) {
            switch (_c.label) {
              ...
              case 1:
                ...
                tipDifference = newShopperTip - oldShopperTip + (newDeliveryPersonTip - oldDeliveryPersonTip); // 5. Update the order with new tips and recalculated total amount
...
exports.updateOrderService = function (orderId, updates) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , orderModel.updateOrder(orderId, updates)];
        ...
        case 3:
          error_1 = _a.sent(); // 3. Handle errors
...
exports.updateOrderStatusService = function (id, status) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      if (!(vendorAmount > 0 && order.vendor.userId)) return [3
                      /*break*/
                      , 3];
                      return [4
                      /*yield*/
                      , wallet_service_1.creditWallet({
                    ...
                    case 3:
                      if (!(order.shopperId && order.shopperTip && order.shopperTip > 0)) return [3
                      /*break*/
                      , 5];
                      return [4
                      /*yield*/
                    ...
                    case 5:
                      if (!(order.deliveryPersonId && order.deliveryPersonTip && order.deliveryPersonTip > 0)) return [3
                      /*break*/
                      , 7];
                      return [4
                      /*yield*/
                    ...
                    case 7:
                      ...
                      return [2
                      /*return*/
                      , orderModel.updateOrder(id, updates, tx)];
                  }
                });
              });
            })];
        ...
        case 6:
          ...
          return [2
          /*return*/
          , orderModel.updateOrder(id, updates, prisma)];
      }
    });
  });
};
...
exports.getAvailableDeliverySlots = function (vendorId, deliveryMethod) {
  return __awaiter(void 0, void 0, Promise, function () {
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          _loop_1 = function _loop_1(i) {
            ...
            var openingHoursToday = vendor.openingHours.find(function (h) {
            ...
            var _a = openingHoursToday.open.split(':').map(Number),
                openHour = _a[0],
                openMinute = _a[1];

            var _b = openingHoursToday.close.split(':').map(Number),
                closeHour = _b[0],
                closeMinute = _b[1];
            ...
            if (deliveryMethod === client_1.DeliveryMethod.customer_pickup) {
              ...
              earliestSlotStartTime = nowInVendorTimezone.add(1, 'hour'); // The latest time a customer can choose is 1 hour before the store closes.

              latestSlotEndTime = closeTime.subtract(1, 'hour');
            } else {
              // delivery_person
              // For delivery, the earliest time is 1.5 hours from now.
              earliestSlotStartTime = nowInVendorTimezone.add(90, 'minutes'); // The latest time is the store's closing time.

              latestSlotEndTime = closeTime; // TODO: The latest delivery time should be adjusted based on the distance
            ...
            var timeSlots = [];
            var currentSlotStart = firstSlotStart; // Generate 1-hour slots until the start of the next slot is past the latest end time.

            while (currentSlotStart.isBefore(latestSlotEndTime)) {
              var slotEnd = currentSlotStart.add(1, 'hour'); // Ensure the entire slot is within the allowed time.
...
exports.getOrdersForVendorDashboard = function (vendorId, options) {
  return __awaiter(void 0, void 0, Promise, function () {
    var defaultStatuses, orders, error_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          defaultStatuses = [client_1.OrderStatus.pending, client_1.OrderStatus.accepted_for_shopping, client_1.OrderStatus.currently_shopping, client_1.OrderStatus.ready_for_delivery, client_1.OrderStatus.ready_for_pickup];
          _a.label = 1;
  ...
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          acceptedOrder = _a.sent(); // --- Add Notification Logic Here ---
        ...
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 3:
                declinedOrder = _a.sent(); // --- Replace TODO with Notification Logic Here ---
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!user || user.vendorId !== vendorId || user.role !== "vendor" && user.role !== "store_shopper") {
...
exports.updateOrderItemShoppingStatusService = function (orderId, itemId, shopperId, payload) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          updatedItem = _a.sent(); // Emit real-time update to the customer

          try {
            io = socket_1.getIO(); // The room is the orderId. The customer and shopper should be in this room.
...
exports.respondToReplacementService = function (orderId, itemId, customerId, payload) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          updatedItem = _a.sent(); // Emit real-time update to the shopper/vendor
...
exports.getOrdersForVendorUserService = function (userId, options) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , vendorModel.getVendorsByUserId(userId)];
        ...
        case 1:
          ...
          userVendorIds = userVendors.map(function (v) {
            return v.id;
          });
          vendorIdsToQuery = userVendorIds; // 2. If a specific vendorId is provided, validate it and narrow the query.
          ...
          return [2
          /*return*/
          , orderModel.findOrdersForVendors({
            vendorIds: vendorIdsToQuery,
            status: status
          })];
      }
    });
