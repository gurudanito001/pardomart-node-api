...
exports.deleteStaffService = exports.updateStaffService = exports.getStaffByIdService = exports.listStaffByOwnerIdService = exports.listStaffByVendorIdService = exports.createStaffService = void 0; // services/staff.service.ts
...
var sanitizeUser = function sanitizeUser(user) {
  ...
  var rememberToken = user.rememberToken,
      sanitized = __rest(user, ["rememberToken"]);
...
exports.createStaffService = function (payload) {
...
exports.listStaffByVendorIdService = function (vendorId, ownerId) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , staffModel.listStaffByVendorId(vendorId)];

        case 2:
          staffList = _a.sent();
          return [2
          /*return*/
          , staffList.map(sanitizeUser)];
      }
    });
  });
};
...
exports.listStaffByOwnerIdService = function (ownerId) {
  return __awaiter(void 0, void 0, Promise, function () {
    var staffList;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , staffModel.listStaffByOwnerId(ownerId)];
...
exports.getStaffByIdService = function (staffId, ownerId) {
  return __awaiter(void 0, void 0, Promise, function () {
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!staffUser || !staffUser.vendorId) {
            return [2
            /*return*/
            , null]; // Staff not found or not associated with any vendor
          }
...
exports.updateStaffService = function (payload) {
  return __awaiter(void 0, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [4
          /*yield*/
          , staffModel.updateStaff(staffId, updateData)];
...
exports.deleteStaffService = function (staffId, ownerId) {
  return __awaiter(void 0, void 0, Promise, function () {
