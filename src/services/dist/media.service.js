...
exports.uploadMedia = function (file, referenceId, referenceType) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!result) {
                            return [2 /*return*/, reject(new Error('Cloudinary upload failed'))];
                        }
                        return [4 /*yield*/, prisma.media.create({
                                data: {
