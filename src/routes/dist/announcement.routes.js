...
// Admin routes
router.post('/', auth_middleware_1.authorize([client_1.Role.admin]), multer_1.upload.single('image'), announcementController.createAnnouncementController);
router.patch('/:id', auth_middleware_1.authorize([client_1.Role.admin]), multer_1.upload.single('image'), announcementController.updateAnnouncementController);
