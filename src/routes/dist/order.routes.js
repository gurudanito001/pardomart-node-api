...
router.get('/vendor', auth_middleware_1.authorizeVendorAccess, validation_middleware_1.validate(validation_middleware_1.validateGetVendorOrders), orderController.getVendorOrdersController);
